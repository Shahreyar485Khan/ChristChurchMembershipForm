        ...
        String s8 = new String(s3);
            ...
            try{
                ...
                if (rs.next())
                {
                    ...
                    {
                         JOptionPane.showMessageDialog(this,"Welcom "+rs.getString("name")+". You logged in as Super Admin.");
                        
                    }else if(access.equals("Admin"))
                    {
                         JOptionPane.showMessageDialog(this,"Welcom "+rs.getString("name")+". You logged in as Admin.");
                    }else if(access.equals("Finance")){
                        
                         JOptionPane.showMessageDialog(this,"Welcom "+rs.getString("name")+". You logged in as Finance.");
                    }else{
